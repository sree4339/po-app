...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onThePurchaseOrdersList.onFilterBar().iCheckFilterField("PO Number");
            ...
            Then.onThePurchaseOrdersList.onFilterBar().iCheckFilterField("Supplier");
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onThePurchaseOrdersList.onTable().iCheckColumns(undefined, {"poNumber":{"header":"PO Number"},"supplier_ID":{"header":"Supplier"},"priority":{"header":"Priority"},"status":{"header":"Status"},"expectedDate":{"header":"Expected Date"},"totalAmount":{"header":"Total Amount"}});
